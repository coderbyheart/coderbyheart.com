...
- [Privilege](/principle/privilege)
- [Push to deploy](/principle/push-to-deploy)
- [5 whys](/principle/five-whys)
- [The 20 percent trick to continuously keep learning](/principle/the-20-percent-trick-to-continuously-keep-learn)

## Best practices

I also collected a set of best practices that are specific instructions rather
then generic principles:

- [Clean .gitignore files](/clean-gitignore-files)
- [Do not change two different things in one Pull Request](/do-not-change-two-different-things-in-one-pull-request)
- [Don't use global state like env variables in modules](/dont-use-global-state-like-env-vars-in-modules)
- [Keep code left](/keep-code-left)
- [PRs should never contain formatting changes](/keep-prs-free-of-formatting-changes)
- [master is the wrong name for the main branch](/master-is-the-wrong-name-for-your-branch)
- [Method calls: favour argument bags over individual arguments](/method-calls-favour-argument-bags-over-individual-arguments)
- [Rebase and ideally Squash instead of Merge Pull Requests](/rebase-and-ideally-squash-instead-of-merge-pull-requests)
- [Separate workflows through events](/separate-workflows-through-events)
- [Readable error messages](/readable-error-messages)
